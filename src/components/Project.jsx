  ...
  return (
    <div className={styles.pr1}>
      ...
      <p className={service.ssp}>
        ...
        requirements and criteria, two distinct types of temperature controlled
        polyhouse structures are being developed for hydroponics farming.
      </p>
      <div className={styles.pr1d}>
        ...
        <div>
          ...
          <p className={service.ssp}>
            Fan & Pad polyhouse is used to control the temperature and humidity
            of the farm as plants require an optimum conditions for maximum
            yield and quality.The internal temperature of the farm can be
            controlled with these fans and pads.
          </p>
          <p className={service.ssp}>
      ...
      <div className={styles.pr2d}>
        <div>
          ...
          <p className={service.ssp}>
            ...
            ventilation, irrigation, Fertigation, and integrated pest management
            are monitored and controlled throughout the season.
          </p>
        </div>
        <div>
      ...
      <div className={styles.pr1d}>
        ...
        <div>
          ...
          <p className={service.ssp}>
            ...
            crops and allow them to grow healthily. It is highly suited to grow
            exotic and Indian leafy green crops such as lettuce, broccoli,
            spinach, bok choy, basil, etc.
          </p>
        </div>
      </div>{" "}
      {/* ************ */}
